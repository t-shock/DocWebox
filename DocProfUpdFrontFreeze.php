				...
				<form action="" method="POST" enctype='multipart/form-data'>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<a href='deleteProfile.php' id="delete"><button class='btn btn-danger' onclick="return confirm('Θέλετε σίγουρα να διαγράψετε τον λογαριασμό σας;');">Διαγραφή λογαριασμού</button></a>
						</div>
					</div>
				</form>
			</div>
