				...
				<form action="" method="POST" enctype='multipart/form-data'>
					...
					<div class="form-group">
						<div class="row"> 
							...
							<div class="col">
								<input type="text" name="loc" value="<?php echo $loc;?>" class="form-control">
							</div>
						</div>
					</div>	
					<div class="row">
						...
						<div class="col-sm-6">
							<form>
								<button type="submit" formaction="DocProfUpdBack.php" target="_blank" class="btn btn-success" name="update_profile">Αποθήκευση Profile</button>
							</form>
						</div>
					</div>
				</form>
